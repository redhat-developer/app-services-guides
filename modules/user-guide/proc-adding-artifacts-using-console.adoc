...
ifdef::rh-openshift[]
image::../_images/registry-web-console-artifact.png[Artifact Details in Registry web console]
endif::[]
+
...
* xref:browsing-artifacts-using-console[Viewing artifacts using the {registry} web console]

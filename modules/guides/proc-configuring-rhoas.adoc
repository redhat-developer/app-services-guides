...
* {base-url}{installation-guide-url-cli}#enabling-command-completion-bash_installing-rhoas-cli[Bash]
* {base-url}{installation-guide-url-cli}#enabling-command-completion-zsh_installing-rhoas-cli[Zsh]
* {base-url}{installation-guide-url-cli}#enabling-command-completion-fish_installing-rhoas-cli[Fish]

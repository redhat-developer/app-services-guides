...
+
IMPORTANT: For details on granting access to service accounts and user accounts, see link:{access-mgmt-service-registry-url}[Managing account access in Red Hat OpenShift Service Registry^].

...
** link:https://search.maven.org/artifact/io.apicurio/apicurio-registry-serdes-protobuf-serde/2.1.0.Final/jar[Protobuf SerDes]
** link:https://search.maven.org/artifact/io.apicurio/apicurio-registry-serdes-jsonschema-serde/2.1.0.Final/jar[JSON Schema SerDes]

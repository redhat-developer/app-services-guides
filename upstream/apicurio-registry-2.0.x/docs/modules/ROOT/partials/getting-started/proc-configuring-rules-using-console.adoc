...
ifdef::rh-openshift-sr[]
. For global rules, click the *Global Rules* tab at the top left of your {registry} instance page, and click *Enable* to configure a global *Validity Rule* or *Compatibility Rule*, and select the appropriate rule configuration from the drop-down. 
endif::[]

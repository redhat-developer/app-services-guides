...
For more overview information about {registry}, see the link:https://access.redhat.com/documentation/en-us/red_hat_openshift_service_registry/[product documentation for {registry-product-long}].

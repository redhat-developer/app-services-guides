...
include::modules/guides/con-binding-openshift-application-using-cli.adoc[leveloffset=+1]

include::modules/guides/proc-verifying-connection-to-openshift-cluster.adoc[leveloffset=+2]

include::modules/guides/proc-connecting-kafka-instance-to-openshift-cluster.adoc[leveloffset=+2]

include::modules/guides/proc-deploying-example-application-in-openshift.adoc[leveloffset=+2]

include::modules/guides/proc-creating-topic-in-kafka-instance.adoc[leveloffset=+2]

include::modules/guides/proc-binding-kafka-instance-to-openshift-application.adoc[leveloffset=+2]

...
This guide describes how to set up `rhoas` so that you can log in and use its commands.

The following procedures demonstrate how to install and configure `rhoas`:

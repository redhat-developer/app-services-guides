...
* You have a running Kafka instance in {product} (see the link:{getting-started-url}[Getting started with Kafka quick start^]).
* You have a running {registry} instance in {registry-product-long} (see the link:{getting-started-service-registry-url}[Getting started with {registry} quick start^]).

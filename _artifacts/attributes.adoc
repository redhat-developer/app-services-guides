...
// external links
* :LinkDebeziumUserGuide: link:#avro-serialization[Avro serialization in Debezium User Guide] 
* :LinkCamelKafkaConnectorGetStart: link:https://access.redhat.com/documentation/en-us/red_hat_integration/2021.q1/html-single/getting_started_with_camel_kafka_connector/index
